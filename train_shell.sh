...
#python ./models/yolo.py --cfg 'ForSmallResBottleneck-Bifpn-upsample-2.yaml'
...
#python ./train.py --cfg 'ForSmallC3InvertBottle-Bifpn-upsample-2.yaml' --epochs '100' --optimizer 'Adam' --hyp './data/hyps/hyp.scratch-low-adam.yaml'
python ./train.py --cfg 'ForSmallResBottleneck-Bifpn-upsample-2.yaml' --epochs '100' --optimizer 'Adam' --hyp './data/hyps/hyp.scratch-low-adam.yaml'
