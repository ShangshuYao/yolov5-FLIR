...
def main(arg):
    ...
    for img in tqdm(data['images']):
        ...
        # filr数据集中文件名格式为thermal_8_bit/FLIR_00001.txt，需要再一次进行转换
        real_name = head.split('/')[1]

        # txt文件名，与对应图片名只有后缀名不一样
        txt_name = real_name + ".txt"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_file', default='D:\\dataset\\FLIR_ADAS_1_3\\val\\thermal_annotations.json',
                        type=str, help="coco file path")
    parser.add_argument('--save_dir', default='D:\\dataset\\FLIR_ADAS_1_3\\val\\labels', type=str,
