...
from models.yolo import DetectionModel, DetectionModelDecouple
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='decouple.yaml', help='model.yaml')
    ...
    model = DetectionModelDecouple(check_yaml(opt.cfg), ch=3, nc=3).to(device)
    # input
